...
- контрольне порівняння довгого світу KIDS показало очікуване зменшення десяти
  непідписаних нейтральних подій з `warn` до `blur`: раніше висновок про
  grooming trajectory повторно входив у contact timeline як нова початкова
  подія та штучно збільшував лічильник з 10 до 11. Після розділення початкових
  подій і висновків пам'яті всі 12 із 12 підписаних небезпечних подій у цьому
  світі залишилися виявленими, а повторне врахування усунено.
